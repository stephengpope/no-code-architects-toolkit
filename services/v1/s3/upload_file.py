...
def stream_file_to_s3(file, custom_filename=None, make_public=False):
    """
    Stream a file directly to S3 using multipart upload.
    ...
    try:
        ...
        # Determine filename (use custom if provided, otherwise use secure version of original)
        if custom_filename:
