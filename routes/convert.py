...
def process_and_notify(media_url, job_id, id, webhook_url):
    try:
        ...
        # Check if the file is already in Google Cloud Storage
        if output_path.startswith('https://storage.googleapis.com/'):
            ...
            # Determine the storage method and upload or move the file accordingly
            if STORAGE_PATH == 'gcp':
                if GCP_BUCKET_NAME:
        ...
        # Check if the upload/move was successful
